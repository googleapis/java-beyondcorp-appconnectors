...
```Groovy
implementation 'com.google.cloud:google-cloud-beyondcorp-appconnectors:0.2.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-beyondcorp-appconnectors" % "0.2.0"
```
